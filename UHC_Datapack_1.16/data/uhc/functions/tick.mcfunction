...
# Always run
    ...
    execute in minecraft:overworld run scoreboard players reset @a[distance=0..,scores={is_in_overworld=1..}] is_in_overworld
    execute in minecraft:the_nether run scoreboard players add @a[distance=0..] is_in_overworld 1
    execute in minecraft:the_end run scoreboard players add @a[distance=0..] is_in_overworld 1

# Trigger Commands
    scoreboard players enable @a help
    scoreboard players enable @a set_center
    scoreboard players enable @a start
    scoreboard players enable @a clear_nether
    ...
    execute at @a[scores={clear_nether=1..}] run function uhc:clear_nether
    execute at @a[scores={top=1..}] run function uhc:top